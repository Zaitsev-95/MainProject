...
import by.itacademy.company.Readers.FileReaderJson;
...
public class ChoiceJson extends StartBaseMenuItem implements MenuItem {
    private Data data = new Data();

    protected ChoiceJson(Data data, MenuItem startMenuItem) {
    ...
    protected void baseExecute() {
        ...
        adoption();
        FileReader fileReader = new FileReaderJson();
    ...
    @Override
    public String name() {
        return "для работы с форматом Json";
    }
}